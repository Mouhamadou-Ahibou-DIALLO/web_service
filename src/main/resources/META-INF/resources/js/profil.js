...
//
//         const postId = post.id; // ✅ plus de ._id.$oid
//
//         div.innerHTML = `
//             <h2>${post.title}</h2>
...
//         .then(post => {
//             const realId = post.id; // ✅ utiliser uniquement post.id
//
...
//             document.getElementById("post-image-title").value = post.image ? post.image.title : "";
//             document.getElementById("post-id").value = realId;
//             document.getElementById("post-popup").style.display = "block";
//         })
//         .catch(error => console.error("Erreur chargement post:", error));
// }
//
